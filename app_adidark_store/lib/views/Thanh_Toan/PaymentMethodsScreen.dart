      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isExpanded?Border.all(width: 2,color: Colors.red):null,
          ),
          child: AnimatedSize(
          ...
          child: ConstrainedBox(
              ...
              children: [
                const Row(
                  children: [
                     ...
                     Text("Thẻ tín dụng/Ghi nợ",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),textAlign: TextAlign.start,),
                  ],
                ),
                isExpanded
                  ? IconButton(
            ...
            if(isExpanded)
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Chi tiết thẻ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                  ...
                  Row(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Ngày tháng hết hạn (dd/MM/YY)",
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
        ...
        GestureDetector(
          ...
          child: const Row(
                  children: [
                     ...
                     Padding(padding: EdgeInsets.only(right: 8)),
                     Text("Thanh toán khi nhận hàng",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),textAlign: TextAlign.start,),
                  ],
                ),
        ),
        ),
